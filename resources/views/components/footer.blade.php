<!-- FOOTER -->
<footer class="bg-[var(--bg-primary)] dark:bg-gray-900">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between">
          <div class="mb-6 md:mb-0">
              <a href="https://flowbite.com/" class="flex items-center">
                  <img src="img/Logo Hyundai.png" class="h-16 md:h-20 ms-4 md:ms-0 md:me-3" alt="Hyundai Logo" />
                  <!-- <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Flowbite</span> -->
              </a>
          </div>
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3 py-4 px-4 md:p-0">
            <!-- Product Link -->
              <div>
              ...
              <div>
                  ...
                  <ul class="text-gray-300 dark:text-gray-400 font-medium">
                      ...
                      <li class="mb-4">
                          ...
                          <!-- Experience Link -->
              <div>
                  <h2 class="mb-6 text-base font-bold text-white uppercase dark:text-white">Experience</h2>
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2025 <a href="https://flowbite.com/" class="hover:underline">Hyundai™</a>. All Rights Reserved.
          </span>
