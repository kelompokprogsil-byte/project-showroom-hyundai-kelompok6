    ...
    <div class="p-4 sm:ml-64 mt-18 sm:mt-8 mb-12">
        ...
        <div class="flex items-center justify-center gap-8 flex-column md:flex-row flex-wrap space-y-4 md:space-y-0 py-4 bg-white dark:bg-gray-900">
            ...
            <div class="relative">
                ...
                <input type="text" id="table-search-users" class="block pt-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-80 bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white" placeholder="Cari kategori...">
            </div>

            {{-- === Tambah Data === --}}
            <button type="button" data-modal-target="editKategoriModal" data-modal-show="editKategoriModal" class="text-sm font-medium border-2 border-white p-2 rounded-sm bg-[var(--bg-secondary)] text-white transition hover:text-[var(--bg-secondary)] hover:bg-transparent hover:border-gray-900">+ Tambah Data</button>
        </div>
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        <td class="px-6 py-4">KTG001</td>
                        <td class="px-6 py-4">Accessories</td>
                        <td class="px-6 py-4 flex flex-col gap-3">
                            <a href="#" type="button" data-modal-target="editKategoriModal" data-modal-show="editKategoriModal" class="font-medium border-2 border-white p-2 rounded-sm bg-[var(--bg-secondary)] text-white hover:text-[var(--bg-secondary)] hover:bg-transparent hover:border-gray-900">Edit Kategori</a>
            ...
            {{-- == MODAL EDIT == --}}
            <div id="editKategoriModal" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden items-center justify-center w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
                <div class="relative w-full max-w-3xl max-h-full">
                    <form class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                        <div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
                            ...
                            <button type="button" class="text-gray-400 hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="editKategoriModal">
                        ...
                        <div class="p-6 space-y-6">
                            <div class="grid grid-cols-6 gap-6">
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">ID Kategori</label>
                                    <input type="text" value="KTG001" readonly class="shadow-xs bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:text-gray-400">
                                </div>
                            ...
                            <div class="justify- col-span-6 sm:col-span-3">
                                ...
                                <div id="dropdownKategori" 
                                    ...
                                    <ul class="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownKategoriButton">
                                        ...
                                        <li class="border-b border-gray-400 mx-3">
                                            <a href="#" data-value="Spare Part"
                                                class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                                                Spare Part
                                            </a>
                                        </li>
                                        <li class="mx-3">
                                            <a href="#" data-value="Vehicle"
                                                class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                                                Vehicle
                                            </a>
                                        </li>
                                ...
                                {{-- Hidden input untuk menyimpan nilai kategori terpilih --}}
                                <input type="hidden" name="kategori" id="kategori_value">
                            </div>
