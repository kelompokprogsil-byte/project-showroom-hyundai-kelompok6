...
<body class="flex flex-col min-h-screen">
    ...
    <!-- Title -->
    <h1 class="text-3xl font-bold mb-2">Booking Form</h1>
    <h2 class="text-lg text-gray-500 mb-6">Product Overview</h2>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
      ...
      <div class="flex justify-center md:justify-end items-start">
        <img src="img/Form/carct3.png" alt="Hyundai Tucson 2025" class="w-72 md:w-80 lg:w-96 object-contain">
      </div>
