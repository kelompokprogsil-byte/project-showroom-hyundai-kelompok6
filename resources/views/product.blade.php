...
<!-- === SIDEBAR === -->
<aside id="default-sidebar" class="fixed top-20 left-0 z-[40] w-64 h-screen md:h-[calc(100vh-5rem)] transition-transform -translate-x-full sm:translate-x-0 mt-19 bg-gray-50 dark:bg-gray-800" aria-label="Sidebar">
  <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
      <ul class="space-y-2 font-medium">
        ...
        <!-- Link 1: Category -->
        <li>
        <button id="dropdownCategory" data-dropdown-toggle="dropdownSidebar1" class="justify-between w-full flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
        ...
        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
            ...
            <!-- Dropdown menu -->
            <div id="dropdownSidebar1" class="z-10 hidden font-normal bg-white divide-y divide-gray-100 rounded-sm shadow-sm dark:bg-gray-700 dark:divide-gray-600 py-4 w-60">
              <ul>
                  <li class="text-sm border-b border-gray-400 mx-3">
        ...
        <!-- Link 2: Year -->
        <li>
        <button id="dropdownYear" data-dropdown-toggle="dropdownSidebar2" class="justify-between w-full flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
        <div class="flex items-center">
        ...
        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
            ...
            <!-- Dropdown menu -->
            <div id="dropdownSidebar2" class="z-10 hidden font-normal bg-white divide-y divide-gray-100 rounded-sm shadow-sm w-60 dark:bg-gray-700 dark:divide-gray-600 py-4">
              <ul>
                  <li class="text-sm border-b border-gray-400 mx-3">
                    <a href="#" class="block px-2 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">About Company</a>
                  </li>
        ...
        <!-- Link 3: Type -->
        <li>
        <button id="dropdownType" data-dropdown-toggle="dropdownSidebar3" class="justify-between w-full flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
        <div class="flex items-center">
        ...
        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
            ...
            <!-- Dropdown menu -->
            <div id="dropdownSidebar3" class="z-10 hidden font-normal bg-white divide-y divide-gray-100 rounded-sm shadow-sm w-60 dark:bg-gray-700 dark:divide-gray-600 py-4">
              <ul>
                  <li class="text-sm border-b border-gray-400 mx-3">
                    <a href="#" class="block px-2 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">About Company</a>
                  </li>
        ...
        <!-- Link 4: Model -->
        <li>
        <button id="dropdownModel" data-dropdown-toggle="dropdownSidebar4" class="justify-between w-full flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
        <div class="flex items-center">
        ...
        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
            ...
            <!-- Dropdown menu -->
            <div id="dropdownSidebar4" class="z-10 hidden font-normal bg-white divide-y divide-gray-100 rounded-sm shadow-sm w-60 dark:bg-gray-700 dark:divide-gray-600 py-4">
              <ul>
                  <li class="text-sm border-b border-gray-400 mx-3">
                    <a href="#" class="block px-2 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">About Company</a>
                  </li>
        ...
        <!-- Link 5: Color -->
        <li>
        <button id="dropdownColor" data-dropdown-toggle="dropdownSidebar5" class="justify-between w-full flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
        <div class="flex items-center">
        ...
        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
            ...
            <!-- Dropdown menu -->
            <div id="dropdownSidebar5" class="z-10 hidden font-normal bg-white divide-y divide-gray-100 rounded-sm shadow-sm w-60 dark:bg-gray-700 dark:divide-gray-600 py-4">
              <ul>
                  <li class="text-sm border-b border-gray-400 mx-3">
                    <a href="#" class="block px-2 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">About Company</a>
                  </li>
        ...
        <!-- Link 6: Price -->
        <li>
        <button id="dropdownPrice" data-dropdown-toggle="dropdownSidebar6" class="justify-between w-full flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
        <div class="flex items-center">
        ...
        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
            ...
            <!-- Dropdown menu -->
            <div id="dropdownSidebar6" class="z-10 hidden font-normal bg-white divide-y divide-gray-100 rounded-sm shadow-sm w-60 dark:bg-gray-700 dark:divide-gray-600 py-4">
              <ul>
                  <li class="text-sm border-b border-gray-400 mx-3">
                    <a href="#" class="block px-2 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">About Company</a>
                  </li>
